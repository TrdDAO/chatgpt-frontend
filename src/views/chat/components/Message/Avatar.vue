...
import chatImage from '@/assets/icons/ChatGPT_logo1.svg'
...
<template>
  <template v-if="image">
    <NAvatar v-if="isType(avatar, 'string') && avatar.length > 0" :src="userImage" :fallback-src="userImage" />
    <NAvatar v-else round :src="userImage" />
  </template>
  <NAvatar v-else round :src="chatImage" />
